...
public class AutoYML<T extends Serializable> {
    ...
    private void ensureParent() {
        ...
        if (parent != null && !parent.exists()) {
            ...
            if (!ok && !parent.exists()) {
                DemocracyElections.getInstance().getLogger().log(Level.WARNING,
    ...
    public T load() {
        synchronized (ioLock) {
            ...
            try (InputStream in = new FileInputStream(file)) {
                ...
                DemocracyElections.getInstance().getLogger().log(Level.SEVERE, "Failed to load YAML: " + file, e);
                return null;
            }
        }
    }
    ...
    public void save(T obj) {
        synchronized (ioLock) {
            ...
            try (Writer w = new FileWriter(file)) {
                ...
                DemocracyElections.getInstance().getLogger().log(Level.SEVERE, "Failed to save YAML: " + file, e);
            }
        }
    }
    ...
    public static <T extends Serializable> AutoYML<T> create(
        ...
        File folder = new File(DemocracyElections.getInstance().getDataFolder(), dataFolder.getPath());
        if (!folder.exists()) {
