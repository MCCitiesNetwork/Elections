...
public interface ElectionsService {
    ...
    CompletableFuture<Optional<Candidate>> updateCandidateAsync(int electionId, int candidateId, String name, String party, String actor);
    ...
    default Optional<Candidate> updateCandidate(int electionId, int candidateId, String name, String party, String actor) { return updateCandidateAsync(electionId, candidateId, name, party, actor).join(); }
