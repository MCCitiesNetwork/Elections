...
import net.democracycraft.elections.internal.ui.manager.create.ElectionCreateWizard;
...
public class ElectionListMenu extends ParentMenuImp {
    ...
    public static class Config implements Serializable {
        ...
        public String rowFormat = "<dark_gray>#%id%</dark_gray> <white><bold>%title%</bold></white> <dark_gray>[</dark_gray><gray>%status%</gray><dark_gray>]</dark_gray> <dark_gray>Voters:%voters% Cand:%cands%</dark_gray>";
        public String createBtn = "<yellow><bold>Create Election</bold></yellow>";
        public String refreshBtn = "<dark_gray>Refresh</dark_gray>";
        public String searchBtn = "<dark_gray>Search</dark_gray>";
        public String clearSearchBtn = "<dark_gray>Clear Search</dark_gray>";
